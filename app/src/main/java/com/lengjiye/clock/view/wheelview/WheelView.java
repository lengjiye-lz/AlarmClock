...
package com.lengjiye.clock.view.wheelview;
...
public class WheelView extends View {
     ...
     */
    private static final int[] SHADOWS_COLORS = new int[]{0xf0ffffff,
            0x60ffffff};
    ...
    private void drawShadows(Canvas canvas) {
        topShadow.setBounds(0, 0, getWidth(), (getHeight() / visibleItems) * 2);
        topShadow.draw(canvas);
        bottomShadow.setBounds(0, getHeight() - (getHeight() / visibleItems) * 2,
                getWidth(), getHeight());
